...
Read [STYLE_PRESETS.md](.claude/commands/frontend-slides/STYLE_PRESETS.md) for safe preset candidates. If [bold-template-pack/selection-index.json](.claude/commands/frontend-slides/bold-template-pack/selection-index.json) exists, read that compact index too, but do not read any `design.md` files yet.
...
- [html-template.md](.claude/commands/frontend-slides/html-template.md) — HTML architecture and JS features
- [viewport-base.css](.claude/commands/frontend-slides/viewport-base.css) — Mandatory CSS (include in full)
- [animation-patterns.md](.claude/commands/frontend-slides/animation-patterns.md) — Animation reference for the chosen feeling
...
| -------------------------------------------------- | -------------------------------------------------------------------- | ------------------------- |
| [STYLE_PRESETS.md](.claude/commands/frontend-slides/STYLE_PRESETS.md)               | 12 curated visual presets with colors, fonts, and signature elements | Phase 2 (style selection) |
| [bold-template-pack/selection-index.json](.claude/commands/frontend-slides/bold-template-pack/selection-index.json) | Compact bold template metadata for candidate selection | Phase 2 (style selection) |
| [bold-template-pack/templates/*/preview.md](.claude/commands/frontend-slides/bold-template-pack/templates/) | Lightweight style cards for shortlisted bold title previews | Phase 2 after shortlisting |
| [bold-template-pack/templates/*/design.md](.claude/commands/frontend-slides/bold-template-pack/templates/) | Detailed design-system docs for the selected bold template only | Phase 3 after user selection |
| [viewport-base.css](.claude/commands/frontend-slides/viewport-base.css)             | Mandatory fixed-stage CSS — copy into every presentation             | Phase 3 (generation)      |
| [html-template.md](.claude/commands/frontend-slides/html-template.md)               | HTML structure, JS features, code quality standards                  | Phase 3 (generation)      |
| [animation-patterns.md](.claude/commands/frontend-slides/animation-patterns.md)     | CSS/JS animation snippets and effect-to-feeling guide                | Phase 3 (generation)      |
| [scripts/extract-pptx.py](.claude/commands/frontend-slides/scripts/extract-pptx.py) | Python script for PPT content extraction                             | Phase 4 (conversion)      |
| [scripts/deploy.sh](.claude/commands/frontend-slides/scripts/deploy.sh)             | Deploy slides to Vercel for instant sharing                          | Phase 6 (sharing)         |
| [scripts/export-pdf.sh](.claude/commands/frontend-slides/scripts/export-pdf.sh)     | Export slides to PDF                                                 | Phase 6 (sharing)         |
